...
#ifndef CK_TEMPLATES_ONLY
/* DEFS: void finished(double impl_noname_0, int impl_noname_1);
 */
void CProxy_Main::finished(double impl_noname_0, int impl_noname_1, const CkEntryOptions *impl_e_opts)
{
  ckCheck();
  //Marshall: double impl_noname_0, int impl_noname_1
  int impl_off=0;
...
int CkIndex_Main::reg_finished_marshall3() {
  int epidx = CkRegisterEp("finished(double impl_noname_0, int impl_noname_1)",
...
void CkIndex_Main::_call_finished_marshall3(void* impl_msg, void* impl_obj_void)
{
  ...
  /*Unmarshall pup'd fields: double impl_noname_0, int impl_noname_1*/
...
void CkIndex_Main::__register(const char *s, size_t size) {
  ...
  // REG: void finished(double impl_noname_0, int impl_noname_1);
