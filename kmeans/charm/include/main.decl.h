...
void done();
void finished(double impl_noname_0, int impl_noname_1);
};
 */
 class Main;
 class CkIndex_Main;
...
class CkIndex_Main:public CkIndex_Chare{
  public:
    ...
    /* DECLS: void finished(double impl_noname_0, int impl_noname_1);
     */
    // Entry point registration at startup
    ...
    inline static int idx_finished(void (Main::*)(double impl_noname_0, int impl_noname_1) ) {
      return idx_finished_marshall3();
    }


    
    static int finished(double impl_noname_0, int impl_noname_1) { return idx_finished_marshall3(); }
 ...
 */
    ...
    void finished(double impl_noname_0, int impl_noname_1, const CkEntryOptions *impl_e_opts=NULL);
