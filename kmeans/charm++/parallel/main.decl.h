...
class CkIndex_Main:public CkIndex_Chare{
  public:
    ...
    /* DECLS: void finished(const std::vector<double> &impl_noname_0, int impl_noname_1);
     */
    // Entry point registration at startup
    
    static int reg_finished_marshall3();
    // Entry point index lookup
    
    inline static int idx_finished_marshall3() {
      static int epidx = reg_finished_marshall3();
      return epidx;
    }

    
    inline static int idx_finished(void (Main::*)(const std::vector<double> &impl_noname_0, int impl_noname_1) ) {
      return idx_finished_marshall3();
    }


    
    static int finished(const std::vector<double> &impl_noname_0, int impl_noname_1) { return idx_finished_marshall3(); }
    
    static void _call_finished_marshall3(void* impl_msg, void* impl_obj);
    
    static void _call_sdag_finished_marshall3(void* impl_msg, void* impl_obj);
    
    static int _callmarshall_finished_marshall3(char* impl_buf, void* impl_obj_void);
    
    static void _marshallmessagepup_finished_marshall3(PUP::er &p,void *msg);
};
/* --------------- element proxy ------------------ */
 ...
 */
    ...
    void finished(const std::vector<double> &impl_noname_0, int impl_noname_1, const CkEntryOptions *impl_e_opts=NULL);
